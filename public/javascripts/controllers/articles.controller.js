...
.controller('ArticlesDetailCtrl', ['$scope', '$http', '$routeParams', '$location', function($scope, $http, $routeParams, $location){
...
.controller('ArticlesCreateCtrl', ['$scope', '$http', '$location', function($scope, $http, $location){
